...
namespace pc
{
    ...
    std::ostream& operator<<(std::ostream& os, COLOR_STREAM color)
    {
        switch (color)
        {
...
#define ROS_ORANGE_STREAM(x)  ROS_INFO_STREAM(pc::ORANGE  << x << pc::ENDCOLOR)
...
#define ROS_O(x) ROS_ORANGE_STREAM(x)  
#define ROS_N(x) ROS_BLACK_STREAM(x)   
#define ROS_R(x) ROS_RED_STREAM(x)     
#define ROS_G(x) ROS_GREEN_STREAM(x)   
#define ROS_Y(x) ROS_YELLOW_STREAM(x)  
#define ROS_B(x) ROS_BLUE_STREAM(x)    
#define ROS_M(x) ROS_MAGENTA_STREAM(x) 
#define ROS_C(x) ROS_CYAN_STREAM(x)    


#define ROS_ORANGE_STREAM_COND(c, x)  ROS_INFO_STREAM_COND(c, pc::ORANGE  << x << pc::ENDCOLOR)
